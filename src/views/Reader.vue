<template>
  <div :style="readStyle">
    ...
    <!--操作面板背景-->
    <div class="nav-pannel-bk font-container" v-if="displayNav&&displayFont"></div>
    <!--控制字体及背景颜色部分-->
    <div class="nav-pannel font-container" v-if="displayNav&&displayFont">
      <div class="child-mod">
        <span>字号</span>
        <button id="large-font" @click="addFont" class="font-size-button">大</button>
        <button id="small-font" @click="decFont" class="font-size-button">小</button>
      </div>
      <div class="child-mod">
        <span>背景</span>
        <div
          ...
          :key="index"
          @click="switchBackGroud(bg)"
          :class="'bk-container '+ bg.class"
        >
    ...
    <div class="bottom-nav" id="bottom_nav" v-if="displayNav">
      ...
      <div class="item" @click="switchFont" id="font-button">
        <div class="item-wrap">
...
export default {
  data() {
    return {
      ...
      bgs: [
        ...
        {
          class: "bg2",
          style: "background: rgb(85, 102, 119);"
        },
        {
          class: "bg3",
          style: "background: rgb(237, 213, 102);"
        },
        {
          class: "bg4",
          style: "background: rgb(255, 153, 136);"
        },
        {
          class: "bg5",
          style: "background: none rgb(0, 0, 0);"
        }
      ],
      chapterContents: {},
      chapter: 0,
  ...
  methods: {
    ...
    onClickLeft(){
      this.$router.replace({ path: `/bookshelf?userId=` });
    },
    ...
    switchFont() {
      this.displayFont = !this.displayFont;
    },
    addFont() {
      if (this.fontSize < 20) {
        this.fontSize++;
  ...
  computed: {
    readStyle() {
      return this.currentStyle + "font-size:" + this.fontSize + "px;";
    }
  }
};
</script>
